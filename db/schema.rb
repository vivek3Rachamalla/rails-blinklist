...
ActiveRecord::Schema.define(version: 2022_03_15_091324) do
  ...
  create_table "new_table", primary_key: "idnew_table", id: :integer, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  end
